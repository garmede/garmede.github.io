...
---
최적화 측면에서 한 프로그램이 셰이더의 종류가 매우 다양하다는 것은 그다지 좋은 상황이 아닙니다. 게임처럼 실시간으로 작동하는 분야에서는 더욱 문제가 될 수도 있지만 다양한 효과를 써야 멋진 아트를 보여주기 좋겠죠.
...
셰이더를 어떻게 돌아 가게 하는지도 중요하지만, 개발을 혼자 하는 것이 아니라면 본인이 만든 셰이더를 다른 사람들이 잘 쓸 수 있게 하는 것도 중요합니다. 유니티는 그런 면에서 꽤 많은 파라미터를 제공해 주고 있습니다. 유니티에서는 이 파라미터들을 머티리얼을 통해 저장하고 프로퍼티(`Properties`)라로 부르고 있습니다. 시작은 간단히 셰이더를 만들어 보겠습니다.
...
이름은 C# 스크립트와 다르게 파일명과 통일시킬 필요가 없습니다. 큰따옴표`"`로 잘 묶어 주기만 한다면 한글도 잘 작동합니다.(잘 작동하긴 하지만 프로그래머들은 싫어할 수도 있습니다.:sweat_smile:)
