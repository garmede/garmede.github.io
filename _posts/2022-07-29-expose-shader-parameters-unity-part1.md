...
> 꼭 한 셰이더를 다양하게 써야 최적화가 되는 것은 아닙니다. 최적화란 것이 쓰는 상황에 따라 늘 달라지기 쉽상입니다. 한 셰이더를 다양하게 쓰기 위해 `if`문이나 베리언츠로 덩치가 마구 마구 커지기 시작하면 그 또한 감당 안 되는 상황이 올 수 있습니다. 셰이더가 너무 무거워져서 프레임이 안 나오거나, 베리언츠 개수가 너무 많아져서 프로그램이 감당하지 못하고 터져 버리기도 합니다.🤯
{: .prompt-info }
